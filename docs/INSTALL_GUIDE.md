...
Official download:
[PurrType-0.1.3.dmg](https://github.com/355070xx/PurrType/releases/download/v0.1.3/PurrType-0.1.3.dmg)
...
下載 `PurrType-0.1.3.dmg`，然後用 Finder 打開。
...
Download `PurrType-0.1.3.dmg`, then open it in Finder.
