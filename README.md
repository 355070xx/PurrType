...
[Download PurrType 0.1.0 DMG](https://github.com/355070xx/PurrType/releases/download/v0.1.0/PurrType-0.1.0.dmg)

其他版本：

[GitHub Releases](https://github.com/355070xx/PurrType/releases)

安裝：

1. 下載並打開 `PurrType-0.1.0.dmg`。
...
Uninstaller 會移除 PurrType app bundles 同 package receipts，並保留本機
preferences 同 New Sucheng learning data。
