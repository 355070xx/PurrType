...
int main(int argc, const char *argv[]) {
    ...
    @autoreleasepool {
        ...
        AssertTrue([preinstall containsString:@"pkill -x PurrTypePreferences"], @"installer stops old preferences helper");
        ...
        AssertTrue([localInstall containsString:@"pkill -x PurrType"], @"local install stops old PurrType process before replacing bundles");
        ...
        AssertTrue([makefile containsString:@"COPYFILE_DISABLE=1 ditto --norsrc"], @"package copy avoids AppleDouble metadata files");
        AssertTrue([makefile containsString:@"! pkgutil --payload-files \"$(PKG_PATH)\" | grep -F '/._'"], @"package smoke rejects AppleDouble metadata payload entries");
        ...
        AssertTrue([preferencesMain containsString:@"Show PurrType Preferences"], @"preferences helper installs app menu entry");
        AssertTrue([preferencesMain containsString:@"Quit PurrType Preferences"], @"preferences helper installs quit menu entry");
